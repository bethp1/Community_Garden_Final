...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card"> 
                <div class="card-header">{{ __('Add Planter') }}</div>
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('planters.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="PlanterType" class="col-md-4 col-form-label text-md-right">{{ __('Type') }}</label>

                            <div class="col-md-6">
                                <input id="PlanterType" type="text" class="form-control{{ $errors->has('PlanterType') ? ' is-invalid' : '' }}" name="PlanterType" value="{{ old('PlanterType') }}" required autofocus>
